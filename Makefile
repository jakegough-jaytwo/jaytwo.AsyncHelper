TOPDIR=$(shell pwd)
BUILD_SLN=./jaytwo.AsyncHelper.sln
BUILD_DIR=./src/jaytwo.AsyncHelper
BUILD_TEST_DIR=./test/jaytwo.AsyncHelper.Tests
BUILD_TRX_FILENAME=jaytwo.AsyncHelper.Tests.trx
